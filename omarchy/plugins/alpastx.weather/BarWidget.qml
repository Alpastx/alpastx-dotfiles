...
BarWidget {
  ...
  readonly property real weatherIconSize: Number(root.setting("iconSize", Style.font.iconLarge))
  readonly property real weatherSlotSize: Number(root.setting("slotSize", Style.bar.iconSlot))
  ...
  BarIconButton {
    ...
    slotSize: root.weatherSlotSize
    fontSize: root.weatherIconSize
    opticalSize: Math.max(root.weatherIconSize, Style.bar.iconCanvas)
